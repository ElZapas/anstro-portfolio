...
const Intro = () => {
  return (
    <BentoGrid>
      ...
      <div className="relative col-span-2 row-span-5 flex flex-col justify-center p-6 bg-azul-claro text-texto-principal rounded-xl overflow-hidden">
      ...
      {/* Imagen Abstracta 1 */}
      <div className="col-span-2 row-span-2 flex items-center justify-center bg-gradient-to-br from-azul-medio to-acento rounded-xl relative">
        <div className="w-24 h-24 bg-white rounded-full shadow-lg"></div>
      </div>

      {/* Imagen Abstracta 2 */}
      <div className="col-span-1 row-span-4 flex items-center justify-center bg-gradient-to-br from-acento to-azul-medio rounded-xl relative">
      ...
      <div className="col-span-2 row-span-3 grid grid-cols-2 gap-4">
        <div className="relative p-4 bg-azul-medio text-texto-principal rounded-xl flex flex-col justify-center text-center">
          ...
          <p className="text-lg font-light italic">UX/UI, diseño minimalista</p>
        </div>
        <div className="relative p-4 bg-azul-medio text-texto-principal rounded-xl flex flex-col justify-center text-center">
